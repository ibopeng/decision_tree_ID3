...
Learn a decision tree and classify the test data
...
# build the tree
dt_root = dt.makeSubtree(instance_data_trn, label_range, num_var, var_types, var_names, var_ranges, None, m)
# print the tree
dt_root.print_tree()

"""
Step 2: classify the test data using trained decision tree, as well as printing out the tree
"""
# load test data
